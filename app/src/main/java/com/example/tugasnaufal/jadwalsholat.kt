...
import kotlinx.android.synthetic.main.jadwalsholat.*
...
class jadwalsholat : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://jamsholat.000webhostapp.com/contoh_jadwal_json.php")
    ...
    {
        AndroidNetworking.post("https://jamsholat.000webhostapp.com/proses_jadwal.php")
