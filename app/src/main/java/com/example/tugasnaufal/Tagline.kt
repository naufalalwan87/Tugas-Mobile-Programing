...
class Tagline : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://jamsholat.000webhostapp.com/contoh_tagline_json.php")
    ...
    {
        AndroidNetworking.post("https://jamsholat.000webhostapp.com/proses_tagline.php")
