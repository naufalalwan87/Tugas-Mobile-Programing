...
class IdentitasMasjid : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://jamsholat.000webhostapp.com/contoh_identitas_json.php")
    ...
    {
        AndroidNetworking.post("https://jamsholat.000webhostapp.com/proses_identitas.php")
