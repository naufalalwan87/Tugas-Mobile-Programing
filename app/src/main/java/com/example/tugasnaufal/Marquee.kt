...
class Marquee : AppCompatActivity() {
    ...
    fun getdariserver(){
        ...
        AndroidNetworking.get("https://jamsholat.000webhostapp.com/contoh_marquee_json.php")
    ...
    {
        AndroidNetworking.post("https://jamsholat.000webhostapp.com/proses_marquee.php")
